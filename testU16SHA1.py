...
class TestSHA1 (unittest.TestCase):
    ...
    def testCopyAndPut1(self):
        """we are testing sha1Key = u16.copyAndPut1(path, uPath, key) """

        # create a random file                          maxLen   minLen
        (dLen, dPath) = self.rng.nextDataFile(DATA_PATH, 16 * 1024, 1)
        dKey = u16.fileSHA1Hex(dPath)

        # invoke function
        (uLen, uKey) = u16.copyAndPut1(dPath, U_PATH, dKey)
    ...
    def testPut1(self):
        ...
        (uLen, uKey) = u16.put1(dPath, U_PATH, dKey)
        uPath = u16.getPathForKey(U_PATH, uKey)
        ...
        (dupeLen, dupeKey) = u16.put1(dupePath, U_PATH, dKey)
    ...
    def testPutData1(self):
        ...
        (uLen, uKey) = u16.putData1(data, U_PATH, dKey)
        self.assertEqual(dKey, uKey)
