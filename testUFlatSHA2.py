...
class TestUFlatSHA2 (unittest.TestCase):
    ...
    def testCopyAndPut(self):
        """we are testing sha1Key = uFlat.copyAndPut2(path, uPath, key) """
        ...
        # invoke function
        (uLen, uKey) = uFlat.copyAndPut2(dPath, U_PATH, dKey)
    ...
    def testPut(self):
        ...
        (uLen, uKey) = uFlat.put2(dPath, U_PATH, dKey)
        uPath = uFlat.getPathForKey(U_PATH, uKey)
        ...
        (dupeLen, dupeKey) = uFlat.put2(dupePath, U_PATH, dKey)
    ...
    def testPutData(self):
        ...
        (uLen, uKey) = uFlat.putData2(data, U_PATH, dKey)
        self.assertEqual(dKey, uKey)
